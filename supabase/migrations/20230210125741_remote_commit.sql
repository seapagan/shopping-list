...
CREATE TABLE "public"."shopping" (
    ...
    "item_bought" boolean DEFAULT false NOT NULL,
    "_before" bigint
);
...
ALTER TABLE "public"."shopping" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: shopping shopping_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."shopping"
    ADD CONSTRAINT "shopping_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: shopping; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."shopping" ENABLE ROW LEVEL SECURITY;

--
-- Name: shopping users can do all to their own data; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users can do all to their own data" ON "public"."shopping" TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
--
-- Name: TABLE "shopping"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "shopping_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."shopping_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."shopping_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."shopping_id_seq" TO "service_role";
